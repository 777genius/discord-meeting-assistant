...
const ENTRYPOINTS: Readonly<Record<HostedCampaignEntrypoint, string>> = Object.freeze({
  ...
  "greeting-ledger-observer": "observe-greeting-ledger.js",
  "historical-reply-observer": "observe-historical-reply-campaign.js",
  "historical-reply-preparer": "prepare-historical-reply-campaign.js",
  "live-memory-observer": "observe-finalized-live-memory.js",
  "private-coverage-observer": "observe-private-campaign-coverage.js",
  "remediation-bundle": "assemble-remediation-bundle.js",
...
const ALLOWED_ENVIRONMENT = new Set([
  "DISCORD_E2E_REMEDIATION_BUNDLE_CAMPAIGN_ID", "DISCORD_E2E_REMEDIATION_BUNDLE_GREETING_INPUT",
  "DISCORD_E2E_REMEDIATION_BUNDLE_HISTORICAL_INPUT", "DISCORD_E2E_REMEDIATION_BUNDLE_LATE_GREETING_INPUT",
  "DISCORD_E2E_REMEDIATION_BUNDLE_LIVE_MEMORY_INPUT", "DISCORD_E2E_REMEDIATION_BUNDLE_OUTPUT",
  "DISCORD_E2E_REMEDIATION_BUNDLE_PRIVATE_COVERAGE_INPUT",
  "DISCORD_E2E_REMEDIATION_BUNDLE_RUN_ID", "DISCORD_E2E_REMEDIATION_BUNDLE_TIMEOUT_MS",
  "DISCORD_E2E_PRIVATE_COVERAGE_CAMPAIGN_ID", "DISCORD_E2E_PRIVATE_COVERAGE_MUTATION_TARGET",
  "DISCORD_E2E_PRIVATE_COVERAGE_OUTPUT", "DISCORD_E2E_PRIVATE_COVERAGE_RUN_ID",
  "DISCORD_E2E_PRIVATE_COVERAGE_SOURCE_INPUT",
  "DISCORD_E2E_HISTORICAL_PREP_ARM_OUTPUT", "DISCORD_E2E_HISTORICAL_PREP_CAMPAIGN_ID",
  "DISCORD_E2E_HISTORICAL_PREP_EVIDENCE_INPUT", "DISCORD_E2E_HISTORICAL_PREP_MUTATION_TARGET",
  "DISCORD_E2E_HISTORICAL_PREP_LATE_GREETING_INPUT", "DISCORD_E2E_HISTORICAL_PREP_V2_TEMPLATE_INPUT",
  "DISCORD_E2E_HISTORICAL_PREP_OUTPUT", "DISCORD_E2E_HISTORICAL_PREP_RECEIPT_OUTPUT",
  "DISCORD_E2E_HISTORICAL_PREP_REMOTE_COMPOSE_FILE", "DISCORD_E2E_HISTORICAL_PREP_REMOTE_ENV_FILE",
  "DISCORD_E2E_HISTORICAL_PREP_REMOTE_HOST", "DISCORD_E2E_HISTORICAL_PREP_REMOTE_SOURCE_ROOT",
  "DISCORD_E2E_HISTORICAL_PREP_RECORDING_READY_INPUT",
  "DISCORD_E2E_HISTORICAL_PREP_RUN_ID", "DISCORD_E2E_HISTORICAL_PREP_TIMEOUT_MS",
  "DISCORD_E2E_HISTORICAL_REPLY_ANSWER_TIMEOUT_MS", "DISCORD_E2E_HISTORICAL_REPLY_INPUT",
  "DISCORD_E2E_HISTORICAL_REPLY_CRASH_RECEIPT_INPUT",
  "DISCORD_E2E_HISTORICAL_REPLY_ADMISSION_RECEIPT", "DISCORD_E2E_HISTORICAL_REPLY_PLAN",
  "DISCORD_E2E_HISTORICAL_REPLY_RELEASE_BINDING",
  "DISCORD_E2E_HISTORICAL_REPLY_KEYCHAIN_SERVICE", "DISCORD_E2E_HISTORICAL_REPLY_MUTATION_TARGET",
  "DISCORD_E2E_HISTORICAL_REPLY_OBSERVER_ACCOUNT", "DISCORD_E2E_HISTORICAL_REPLY_OUTPUT",
  "DISCORD_E2E_HISTORICAL_REPLY_POLL_INTERVAL_MS", "DISCORD_E2E_HISTORICAL_REPLY_REMOTE_COMPOSE_FILE",
  "DISCORD_E2E_HISTORICAL_REPLY_REMOTE_ENV_FILE", "DISCORD_E2E_HISTORICAL_REPLY_REMOTE_HOST",
  "DISCORD_E2E_HISTORICAL_REPLY_REMOTE_SOURCE_ROOT", "DISCORD_E2E_HISTORICAL_REPLY_REMOTE_TIMEOUT_MS",
  "DISCORD_E2E_HISTORICAL_REPLY_RUN_ID", "DISCORD_E2E_HISTORICAL_REPLY_SECRET_DIRECTORY",
  "DISCORD_E2E_LIVE_MEMORY_CAMPAIGN_ID", "DISCORD_E2E_LIVE_MEMORY_MUTATION_TARGET",
  "DISCORD_E2E_LIVE_MEMORY_OUTPUT", "DISCORD_E2E_LIVE_MEMORY_POLL_INTERVAL_MS",
  "DISCORD_E2E_LIVE_MEMORY_REMOTE_COMPOSE_FILE", "DISCORD_E2E_LIVE_MEMORY_REMOTE_ENV_FILE",
  "DISCORD_E2E_LIVE_MEMORY_REMOTE_HOST", "DISCORD_E2E_LIVE_MEMORY_REMOTE_SOURCE_ROOT",
  "DISCORD_E2E_LIVE_MEMORY_RUN_ID", "DISCORD_E2E_LIVE_MEMORY_TIMEOUT_MS",
  "DISCORD_E2E_GREETING_LEDGER_CAMPAIGN_ID", "DISCORD_E2E_GREETING_LEDGER_CAMPAIGN_PROOF_INPUT",
  "DISCORD_E2E_GREETING_LEDGER_CAPTURE_INPUTS", "DISCORD_E2E_GREETING_LEDGER_MUTATION_TARGET",
  "DISCORD_E2E_GREETING_LEDGER_OUTPUT", "DISCORD_E2E_GREETING_LEDGER_REMOTE_COMPOSE_FILE",
  "DISCORD_E2E_GREETING_LEDGER_REMOTE_ENV_FILE", "DISCORD_E2E_GREETING_LEDGER_REMOTE_HOST",
  "DISCORD_E2E_GREETING_LEDGER_REMOTE_SOURCE_ROOT", "DISCORD_E2E_GREETING_LEDGER_REMOTE_TIMEOUT_MS",
  "DISCORD_E2E_GREETING_LEDGER_RUN_ID",
  ...
  "DISCORD_E2E_CONVERSATION_VOICE_LATE_GREETING_LEDGER_INPUT", "DISCORD_E2E_CONVERSATION_VOICE_LATE_GREETING_OUTPUT",
...
export const SSH_RUNTIME_ENTRYPOINTS: ReadonlySet<HostedCampaignEntrypoint> = new Set([
  "collector", "greeting-ledger-observer", "historical-reply-observer", "historical-reply-preparer",
  "live-memory-observer", "provenance-probe", "recording-ready",
  "replay-attestation-publisher", "service-level-sources",
]);
...
export function argumentsFor(spec: HostedCampaignExecutableSpec): readonly string[] {
  ...
  return [args.manifestPath, ...args.evidencePaths,
    ...(args.historicalReplyPath === undefined
      ? [] : ["--historical-reply", args.historicalReplyPath]),
    ...(args.thinRemediationPath === undefined
      ? [] : ["--thin-remediation", args.thinRemediationPath]),
