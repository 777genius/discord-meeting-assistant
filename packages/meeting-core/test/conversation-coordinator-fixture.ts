import type { FinalizedConversationTurnInput } from "../src/application/conversation.js";
import type {
...
class RecordingPlaybackSession implements VoicePlaybackSession {
  ...
  public write(chunk: ConversationAudioChunk): Promise<PortResult<"accepted" | "reused">> {
...
class HeldFinishPlaybackSession extends RecordingPlaybackSession {
  public override finish(): Promise<PortResult<"finished" | "reused">> {
    this.finishCalls += 1;
    return Promise.resolve({ ok: true, value: "finished" });
  }
