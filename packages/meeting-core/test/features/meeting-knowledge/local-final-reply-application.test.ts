...
import { AppliedStore, TestIds, makeMeeting } from "../../fixtures/historical-retrieval-fixtures.js";
...
describe("ProcessFinalReplyJob answer generation", () => {
  ...
  it.each([
    ...
    memory.result = memoryStatus === "low_coverage" ? { authorityGeneration: authority.memoryGeneration, schemaVersion: 1, status: memoryStatus } : { schemaVersion: 1, status: memoryStatus };
