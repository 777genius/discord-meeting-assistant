...
import type { LiveMeetingFailure } from "./ports/live-meeting.js";
import {
  currentTurns,
...
export interface GeneratedResult {
  readonly failure?: LiveMeetingFailure;
...
export function invalidGenerationFailure(error: unknown): LiveMeetingFailure {
  return {
