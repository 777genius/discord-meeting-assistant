...
export const requiredRelations = [
  ...
  "meeting_core.recording_publication_reconciliations",
  "meeting_core.conversation_greeting_capacity_admissions",
...
export const requiredIndexes = [
  ...
  "meeting_core.recording_publication_reconciliations_pending_idx",
  "meeting_core.conversation_greeting_capacity_admissions_scope_idx",
  ...meetingKnowledgeRequiredIndexes,
] as const;
...
export const requiredColumns = [
  ...
  "meeting_core.recording_publication_reconciliations.meeting_id",
  "meeting_core.recording_publication_reconciliations.external_publication_id",
  "meeting_core.recording_publication_reconciliations.request_payload",
  "meeting_core.recording_publication_reconciliations.state",
  "meeting_core.recording_publication_reconciliations.lease_owner",
  "meeting_core.recording_publication_reconciliations.lease_expires_at",
  "meeting_core.recording_publication_reconciliations.created_at",
  "meeting_core.recording_publication_reconciliations.completed_at",
  "meeting_core.conversation_greeting_capacity_admissions.scope_id",
  "meeting_core.conversation_greeting_capacity_admissions.receipt_id",
  "meeting_core.conversation_greeting_capacity_admissions.admitted_at",
...
export const requiredCheckConstraints = [
  ...
  [
    "meeting_core",
    "recording_publication_reconciliations",
    "recording_publication_reconciliations_values_are_valid",
  ],
  [
    "meeting_core",
    "conversation_greeting_capacity_admissions",
    "conversation_greeting_capacity_scope_is_valid",
  ],
  [
    "meeting_core",
    "conversation_greeting_capacity_admissions",
    "conversation_greeting_capacity_receipt_is_valid",
  ],
...
export const requiredStructuralConstraints = [
  ...
  [
    "meeting_core",
    "recording_publication_reconciliations",
    "recording_publication_reconciliations_pkey",
    "p",
  ],
  [
    "meeting_core",
    "conversation_greeting_capacity_admissions",
    "conversation_greeting_capacity_admissions_pkey",
    "p",
  ],
